...
API_KEY = 'tsZU6vUw3ow0'
PROJECT_TOKEN = 'tujwTALYVeW_'
RUN_TOKEN = 'tQFMBVzmUDZG'
...
def main():
    ...
    country_patterns = {
        ...
        re.compile('[\w\s]+ serious or critical [\w\s]+'): lambda country: data.get_country_data(country)['Serious_or_Critical'],
